...
function TabelaImc(props: TabelaImcProps) {
  return (
    <div className='mx-2 mb-2'>
      ...
      <div
        className={
          'flex ' + (props.imc >= 18.5 && props.imc <= 24.9 ? 'destaque' : '')
        }
      >
      ...
      <div
        className={
          'flex ' + (props.imc >= 25 && props.imc <= 29.9 ? 'destaque' : '')
        }
      >
      ...
      <div
        className={
          'flex ' + (props.imc >= 30 && props.imc <= 34.9 ? 'destaque' : '')
        }
      >
      ...
      <div
        className={
          'flex ' + (props.imc >= 35 && props.imc <= 39.9 ? 'destaque' : '')
        }
      >
